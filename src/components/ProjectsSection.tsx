...
import { Projects, Cards, CardsDiv } from '../styles/ProjectsSection.styles';
                            ...
                            <HorizontalPadding key={key}>
                                <CardsDiv>
                                    ...
                                    <div className='CardsTech'>
                                        {el.technologies.map((icon, key) => <img src={icon.img} alt={icon.alt} key={key} title={icon.alt}></img>)}
                                    </div>

                                    <div className='CardsLinks'>
                                        <a href={el.liveLink}>Veja o site</a>
                                        <a href={el.github}>
