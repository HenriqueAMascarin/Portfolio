...
export default function InfoSection() {
  ...
  return (
    <Info id="about" className="principalSections">
      <VerticalPadding>
        <HorizontalPadding>
          <MaxWidthCapsule>
            <div className="infoDiv">
              <img
                ...
                height="510"
                src={photo}
                alt={translateI18n("general.altPhoto")}
              />

              <div>
                <h2>{translateI18n("mainPage.aboutSection.title")}</h2>
                ...
                <div className="infoAction">
                  <div className="infoIcons">
                    <a
                      href="https://www.linkedin.com/in/henriqueamasc/"
                      target="_blank"
                    >
                      <svg
                        viewBox="0 0 50 50"
                    ...
                    <a
                      href="https://github.com/HenriqueAMascarin"
                      target="_blank"
                    >
                      <svg
                        viewBox="0 0 52 50"
                  ...
                  >
                    ...
                    >
                      <path
                        d="M8.5 31.6C8.5 32.7046 9.39543 33.6 10.5 33.6H23.5C24.6046 33.6 25.5 32.7046 25.5 31.6V31.4C25.5 30.2954 24.6046 29.4 23.5 29.4H10.5C9.39543 29.4 8.5 30.2954 8.5 31.4V31.6ZM8.5 23.2C8.5 24.3046 9.39543 25.2 10.5 25.2H23.5C24.6046 25.2 25.5 24.3046 25.5 23.2V23C25.5 21.8954 24.6046 21 23.5 21H10.5C9.39543 21 8.5 21.8954 8.5 23V23.2ZM4.25 42C3.08125 42 2.08073 41.5887 1.24844 40.7663C0.416146 39.9438 0 38.955 0 37.8V4.2C0 3.045 0.416146 2.05625 1.24844 1.23375C2.08073 0.41125 3.08125 0 4.25 0H20.4285C20.9548 0 21.4599 0.207478 21.8343 0.577443L33.4058 12.0128C33.786 12.3885 34 12.9008 34 13.4354V37.8C34 38.955 33.5839 39.9438 32.7516 40.7663C31.9193 41.5887 30.9188 42 29.75 42H4.25ZM19.125 13.7C19.125 14.2523 19.5727 14.7 20.125 14.7H27.3154C28.2092 14.7 28.6541 13.617 28.0183 12.9887L20.8279 5.88287C20.1963 5.25865 19.125 5.7061 19.125 6.59415V13.7Z"
                        fill="#212121"
                      />
                    </svg>
                    {translateI18n("mainPage.aboutSection.curriculum")}
                  </a>
                </div>
              </div>
            </div>
