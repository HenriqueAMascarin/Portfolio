...
export const projectsIds = {
  bobsCarDealer: "projects/bobs-car-dealer",
  starTShirts: "projects/star-t-shirts",
  mediaTimer: "projects/media-timer",
  ebooks: "projects/ebooks",
  portfolio: "projects/portfolio",
  godOfWar: "projects/god-of-war",
};
...
export default function ProjectsSection() {
  let arrayCards: ProjectsCardsType = [
    ...
    },
    {
      ...
      googleLink:
        "https://play.google.com/store/apps/details?id=com.henriqueamascarin.mediatimer",
      figma:
        "https://www.figma.com/design/XTRDCbSVe8lHtwkXK1Z5T7/Media-Timer?t=2WIleknFjgiShuOE-1",
    ...
    },
    {
      ...
      figma:
        "https://www.figma.com/design/kXWxgIgNvyTrPiVUZj0g15/Car-dealer-app?node-id=0-1&t=0mhG1m6I7AekNfjJ-1",
    ...
    },
    {
      ...
      technologies: [VueSvg, PiniaSvg, TailwindSvg, HtmlSvg, FigmaSvg],
      liveLink: "https://e-books-web.vercel.app",
      figma:
        "https://www.figma.com/design/GrGuOJvXLsZbMAGJY7DkIS/e-books?t=2WIleknFjgiShuOE-1",
    ...
    },
    {
      ...
      figma:
        "https://www.figma.com/design/PpIlwTZD08v6Z1ltXUyWNg/Portfolio?t=BO3o9X3cLLssikCk-1",
    ...
    },
    {
      ...
      technologies: [ReactSvg, TypeScriptSvg, SassSvg, HtmlSvg, FigmaSvg],
      liveLink: "https://godofwar-shop.vercel.app",
      figma:
        "https://www.figma.com/design/fFnrpY4zrUWgRxo06TTjs1/god-of-war?t=2WIleknFjgiShuOE-1",
                    ...
                    <div className="divImg">
                      <p
                        className={`statusProject ${
                          project.underDevelopment && "developmentStatusProject"
                        }`}
                      >
                        {translateI18n(
                          `mainPage.projectsSection.${
                            ...
                            >
                              ...
                              >
                                ...
                                <path
                                  fillRule="evenodd"
                                  clipRule="evenodd"
                                  d="M14 23C14 18.996 17.246 15.75 21.25 15.75C25.254 15.75 28.5 18.996 28.5 23C28.5 27.004 25.254 30.25 21.25 30.25C17.246 30.25 14 27.004 14 23Z"
                                  fill="#212121"
                                />
                                <path
                                  fillRule="evenodd"
                                  clipRule="evenodd"
                                  d="M0.5 36.5C0.5 32.496 3.74593 29.25 7.75 29.25H15V36.5C15 40.504 11.754 43.75 7.75 43.75C3.74593 43.75 0.5 40.504 0.5 36.5Z"
                                  fill="#212121"
                                />
                                <path
                                  fillRule="evenodd"
                                  clipRule="evenodd"
                                  d="M14 2.25V16.75H21.25C25.254 16.75 28.5 13.504 28.5 9.5C28.5 5.49593 25.254 2.25 21.25 2.25H14Z"
                                  fill="#212121"
                                />
                                <path
                                  fillRule="evenodd"
                                  clipRule="evenodd"
                                  d="M0.5 9.5C0.5 13.504 3.74593 16.75 7.75 16.75H15V2.25H7.75C3.74593 2.25 0.5 5.49593 0.5 9.5Z"
                                  fill="#212121"
                                />
                                <path
                                  fillRule="evenodd"
                                  clipRule="evenodd"
                                  d="M0.5 23C0.5 27.004 3.74593 30.25 7.75 30.25H15V15.75H7.75C3.74593 15.75 0.5 18.996 0.5 23Z"
                                  fill="#212121"
                                />
                              </svg>
                            </a>
